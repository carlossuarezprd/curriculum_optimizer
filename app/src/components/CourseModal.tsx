  ...
  return (
    <div className="mb-1.5 flex items-center gap-3 rounded-lg border border-line bg-surface2 p-2.5 text-sm">
      ...
      <div className="text-right text-xs">
        ...
        {section.quarter === "Autumn" && section.unavailable_new && <div className="text-[10px] text-danger" title="New students (Autumn Y1, late phase) were shut out — CLO">Autumn Y1: unavailable</div>}
      </div>
      <button
